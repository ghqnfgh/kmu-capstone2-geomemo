package capstone2.kookmin.geomemo;
...
import capstone2.kookmin.geomemo.common.TitleBitmapButton;
import capstone2.kookmin.geomemo.db.MemoDatabase;
 ...
 * @author Mike
 */
public class GeoMemoActivity extends Activity {
    public static final String TAG = "GeoMemoActivity";
    ...
    public int loadMemoListData() {
        ...
        int recordCount = -1;
        if (GeoMemoActivity.mDatabase != null) {
            Cursor outCursor = GeoMemoActivity.mDatabase.rawQuery(SQL);
    ...
    public String getPhotoUriStr(String id_photo) {
        ...
        if (id_photo != null && !id_photo.equals("-1")) {
            ...
            Cursor photoCursor = GeoMemoActivity.mDatabase.rawQuery(SQL);
