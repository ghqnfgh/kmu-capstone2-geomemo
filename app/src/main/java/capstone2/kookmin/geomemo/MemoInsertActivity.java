...
import capstone2.kookmin.geomemo.common.TitleBackgroundButton;
    ...
    private void saveInput() {
        ...
        if (photoFilename != null) {
            ...
            if (GeoMemoActivity.mDatabase != null) {
                Cursor cursor = GeoMemoActivity.mDatabase.rawQuery(SQL);
        ...
        Log.d(TAG, "SQL : " + SQL);
        if (GeoMemoActivity.mDatabase != null) {
            GeoMemoActivity.mDatabase.execSQL(SQL);
        }
    ...
    private void modifyInput() {
        ...
        if (photoFilename != null) {
            ...
            if (GeoMemoActivity.mDatabase != null) {
                ...
                if (GeoMemoActivity.mDatabase != null) {
                    GeoMemoActivity.mDatabase.rawQuery(SQL);
                }
